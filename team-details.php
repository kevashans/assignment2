              ...
              <div class="card-body">
                <h5 class="card-title ">
                  <a href="#" class="text-decoration-none"
                    onclick="ContentPagePlayers('<?php echo $product['playerID'] ?>'); return false"><?php echo $product['player_name']; ?></a>
                </h5>
                <p class="card-text">
          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">
                  <a href="#" class="text-decoration-none"
                    onclick="ContentPageScouts('<?php echo $scout['scoutID'] ?>'); return false"
                    class="stretched-link"><?php echo $scout['scout_name']; ?></a>
